...
var host = new HostBuilder()
    .ConfigureOpenApi() // This method is now recognized due to the added using directive
    ...
    .ConfigureServices(services =>
    {
        ...
        {
            options.UseNpgsql(Configuration.AppSettings["Values:ConnectionStrings:DefaultConnection"],
                npgsqlAction =>
                {
